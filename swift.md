...
Then import the `KiwiSolver` product.
...
Running `cmake .` without `-DKIWI_SWIFT_WRAPPER=ON` doesn't touch any of
this. The Swift package is invisible to the C++/Python build.
